    ...
    return (
      <Col className="col-12">
        <Card className="bg-white shadow mt-3">
          <Row className="h-100">
            <Col className={`col-12 col-md-4 ${isLeft ? "order-md-1" : "order-md-2"}`}>
              <Image className={`${isLeft ? "rounded-left" : "rounded-right"}`} image={this.props.image} />
            </Col>
            <Card.Body className={`col-12 col-md-8 px-5 ${isLeft ? "order-md-2" : "order-md-1"}`}>
